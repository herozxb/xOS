...
//! return fdc status
extern uint8_t flpydsk_read_status () {
...
extern void flpydsk_write_ccr (uint8_t val) {
...
extern void flpydsk_check_int (uint32_t* st0, uint32_t* cyl) {
...
extern void flpydsk_control_motor (bool b) {
...
//! configure drive
extern void flpydsk_drive_data (uint32_t stepr, uint32_t loadt, uint32_t unloadt, bool dma ) {
...
extern int flpydsk_calibrate (uint32_t drive) {
...
//! disable controller
extern void flpydsk_disable_controller () {
...
extern int flpydsk_seek ( uint32_t cyl, uint32_t head ) {
